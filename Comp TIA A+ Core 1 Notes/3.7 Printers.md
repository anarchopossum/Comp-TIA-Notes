...
uses a print head to print layers from the "ground up"
## Resin Printer (SLA)
3D printer with more detail than FDM.
- Liquid Resin is attached to a build platform
- an ultraviolet light is used to harden resin into the print/ build platform.
- very toxic resin.
### Print Bed
A flat surface to print items
- needs to be clean
- needs to be leveled
- Filament printers need heated beds
- Resin printers the bottom of the resin tank is the print bed where the UV light hits.